...
export enum EmoticonIconSize {
    MINI,
    NORMAL
}

interface Props {
    size: EmoticonIconSize
}

class EmoticonIcon extends Component<Props> {
    render(): ReactNode {
        switch(this.props.size) {
            case EmoticonIconSize.MINI:
                return (
                    <svg color="#8e8e8e" fill="#8e8e8e" height="13" role="img" viewBox="0 0 24 24" width="13">
